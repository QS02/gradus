...
export const verticalMenuItems = [ 
    ...
    new Menu (2, 'Forms', null, null, 'assignment', null, true, 0),
    new Menu (3, 'STA Summary', '/forms/sta-summary', null, 'assignment_ind', null, false, 2) ,
    new Menu (4, 'New STA', '/new-sta', null, 'assessment', null, false, 0) ,
    new Menu (5, 'Crew', '/crew', null, 'people', null, false, 0) ,
    // new Menu (5, 'Users', '/users', null, 'supervisor_account', null, false, 0), 
    new Menu (6, 'Settings', '/settings', null, 'settings', null, false, 0) ,
   ...
   /*
    ...
    new Menu (144, 'Level 5', null, 'http://google.com', 'link', null, false, 143),
    new Menu (200, 'External Link', null, 'http://google.com', 'open_in_new', '_blank', false, 0)
    */
]
...
export const horizontalMenuItems = [ 
    ...
    new Menu (200, 'External Link', null, 'http://google.com', 'open_in_new', '_blank', false, 40)
]